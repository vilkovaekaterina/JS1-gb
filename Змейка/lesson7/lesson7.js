...
function prepareGameField() {
    ...
    document.getElementsByClassName('buttons')[0].appendChild(score);
}
...
function startGame() {
    ...
    bombCreating = setInterval(createBomb, 10000);
}
...
function move() {
    ...
    if (!isSnakeUnit(new_unit) && new_unit !== undefined && !getBomb(new_unit)) {
...
function createBomb() {
    ...
    setTimeout(function (){
        bomb_cell.setAttribute('class', bomb_cell_classes[0]+ ' ' + bomb_cell_classes[1]);
        }, 5000);
    //return bombCreated;
}
